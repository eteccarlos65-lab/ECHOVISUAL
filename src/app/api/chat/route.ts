...
export async function POST(req: Request) {
  ...
  const result = streamText({
    ...
    system: `
      ...
      Exemplos de eventos: "RIGHT_HAND_UP", "LEFT_HAND_UP", "HAND_OPEN", "HANDS_SPREAD", "PINCH", "BOTH_HANDS_UP".
      Exemplos de efeitos disponíveis: "ENERGY_AURA", "PARTICLE_BURST", "PORTAL", "FIRE", "LIGHTNING", "INVISIBILITY_CLOAK", "NONE".
